...
# vang
JVM_OPTS="$JVM_OPTS -javaagent:$CASSANDRA_HOME/lib/jmx_prometheus_javaagent-0.12.0.jar=9404:/etc/cassandra/cassandra_jmx_exporter.yaml"
...
# JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname=c1"
#
# see
